...
export function CrearDonacion() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // URL CORREGIDA: eliminar "/donaciones" duplicado
      const response = await fetch("http://localhost:5000/api/donaciones/donaciones", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.mensaje || "Error al crear donación");
      }
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                      ...
                      <div className="flex justify-end space-x-4 border-t dark:border-gray-700 pt-6">
                        ...
                        <button
                          ...
                          className="px-6 py-2 bg-green-600 dark:bg-green-700 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-800 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors"
                        >
                          {isSubmitting ? (
