...
export function EditarPaciente() {
  ...
  useEffect(() => {
    const fetchPaciente = async () => {
      try {
        const token = localStorage.getItem("token");
        const response = await fetch(`http://localhost:5000/api/pacientes/pacientes/${id}`, {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={paciente.raza}
                        onChange={(e) => setPaciente({...paciente, raza: e.target.value})}
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 dark:text-white"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={paciente.edad ?? ""} // Previene errores si edad es undefined o null
                        min={0} // Asegura que no ingresen edades negativas
                        onChange={(e) =>
                            setPaciente({ ...paciente, edad: Number(e.target.value) }) // convierte a número
                        }
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 dark:text-white"
                        required
                        />
