...
export function CrearPaciente() {
    ...
    const [paciente, setPaciente] = useState<Paciente>({
        id: 0, // Valor temporal que se actualizará al crear
        nombre: '',
        especie: '',
        raza: '',
        edad: 0
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const token = localStorage.getItem("token");
            const response = await fetch("http://localhost:5000/api/pacientes/pacientes", {
                method: "POST",
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.mensaje || "Error al crear paciente");
            }
